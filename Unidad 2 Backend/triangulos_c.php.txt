...
//acutangulo obstucangulo o rectangulo respuestas
echo tipo_lados2(30,90,60).'<br>';
echo tipo_lados2(60,60,60).'<br>';
echo tipo_lados2(30,30,120).'<br>';
//escaleno isosceles o equilatero respuestas
